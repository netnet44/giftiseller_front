...
const Default = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1971px] overflow-hidden text-left text-3xl text-gray-400 font-pretendard">
      <div className="absolute top-[270px] left-[calc(50%_-_68px)] text-17xl font-extrabold text-center flex items-center justify-center w-[136px] h-[39px]">
        회원가입
      </div>
      <b className="absolute top-[364px] right-[1242px] flex items-center w-[182px] h-5">
        필수입력 정보*
      </b>
      <b className="absolute top-[1072px] right-[1242px] flex items-center w-[182px] h-5">
        추가입력 정보
      </b>
      <img
        className="absolute top-[398px] left-[495px] w-[930px] h-0.5"
        alt=""
        src="/vector-7.svg"
      />
      <img
        className="absolute top-[1106px] left-[495px] w-[930px] h-0.5"
        alt=""
        src="/vector-7.svg"
      />
      <div className="absolute top-[1137px] left-[557px] w-[806px] h-[205px] text-lg">
        <div className="absolute top-[0px] left-[155px] rounded-8xs box-border w-[651px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[75px] left-[155px] rounded-8xs box-border w-[651px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[150px] left-[155px] rounded-8xs box-border w-[651px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[17px] right-[642px] font-medium flex items-center w-[164px] h-5">
          구매경로
        </div>
        <div className="absolute top-[92px] right-[642px] font-medium flex items-center w-[164px] h-5">
          구매하실 상품권
        </div>
        <div className="absolute top-[167px] right-[642px] font-medium flex items-center w-[164px] h-5">
          사용처
        </div>
        <div className="absolute top-[167px] right-[467px] text-base font-light text-dimgray-100 flex items-center w-[164px] h-5">
          사용처를 선택해주세요
        </div>
        <div className="absolute top-[92px] right-[374px] text-base font-light text-dimgray-100 flex items-center w-[257px] h-5">
          구매하시는 상품권을 선택해주세요
        </div>
        <img
          className="absolute top-[97.5px] left-[772.5px] rounded-10xs w-[15px] h-[7.8px]"
          alt=""
          src="/vector-91.svg"
        />
        <img
          className="absolute top-[172.5px] left-[772.5px] rounded-10xs w-[15px] h-[7.8px]"
          alt=""
          src="/vector-91.svg"
        />
      </div>
      <div className="absolute right-[4px] bottom-[0px] w-[1920px] h-[406px] text-smi text-dimgray-300 font-noto-sans-kr">
        ...
        <img
          className="absolute h-[0.25%] w-full top-[-0.12%] right-[-0.21%] bottom-[99.88%] left-[0.21%] rounded-10xs max-w-full overflow-hidden max-h-full"
          alt=""
          src="/vector-18.svg"
        />
        <img
          className="absolute h-[0.25%] w-full top-[15.15%] right-[-0.21%] bottom-[84.61%] left-[0.21%] rounded-10xs max-w-full overflow-hidden max-h-full"
          alt=""
          src="/vector-18.svg"
        />
      ...
      <img
        className="absolute right-[35px] bottom-[448px] w-[120px] h-[120px]"
        alt=""
        src="/-btn.svg"
      />
      <div className="absolute right-[50px] bottom-[573px] w-[90px] h-[90px] text-center text-45xl text-limegreen-200">
      ...
      <div className="absolute top-[429px] left-[557px] w-[806px] h-[568px] text-lg">
        <div className="absolute top-[75px] left-[155px] rounded-8xs box-border w-[651px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[15px] right-[642px] font-medium flex items-center w-[164px] h-5">
          아이디
        </div>
        <div className="absolute top-[92px] right-[642px] font-medium flex items-center w-[164px] h-5">
          비밀번호
        </div>
        <div className="absolute top-[92px] right-[318px] text-base font-light text-dimgray-100 flex items-center w-[313px] h-5">
          **********
        </div>
        <div className="absolute top-[167px] right-[318px] text-base font-light text-dimgray-100 flex items-center w-[313px] h-5">
          **********
        </div>
        <div className="absolute top-[530px] right-[318px] text-base font-light text-dimgray-100 flex items-center w-[313px] h-5">
          상세 주소를 입력하세요
        </div>
        <div className="absolute top-[17px] right-[478px] text-base font-light text-dimgray-100 flex items-center w-[153px] h-5">
          aaa0000
        </div>
        <div className="absolute top-[17px] right-[22px] text-base font-medium text-darkturquoise-100 text-center flex items-center justify-center w-[62px] h-5">
          중복확인
        </div>
        <div className="absolute top-[321px] right-[318px] font-medium text-darkgray-200 flex items-center w-[15px] h-5">
          @
        </div>
        <div className="absolute top-[245px] right-[642px] font-medium flex items-center w-[164px] h-5">
          이름
        </div>
        <div className="absolute top-[167px] right-[642px] font-medium flex items-center w-[164px] h-5">
          비밀번호 확인
        </div>
        <div className="absolute top-[320px] right-[642px] font-medium flex items-center w-[164px] h-5">
          이메일
        </div>
        <div className="absolute top-[390px] right-[642px] font-medium flex items-center w-[164px] h-5">
          휴대폰 번호
        </div>
        <div className="absolute top-[460px] right-[744px] font-medium flex items-center w-[62px] h-5">
          주소
        </div>
        <div className="absolute top-[228px] left-[155px] rounded-8xs box-border w-[651px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[150px] left-[155px] rounded-8xs box-border w-[651px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[303px] left-[155px] rounded-8xs box-border w-[302px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[303px] left-[503px] rounded-8xs box-border w-[303px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[373px] left-[155px] rounded-8xs box-border w-[490px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[443px] left-[155px] rounded-8xs box-border w-[490px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[513px] left-[155px] rounded-8xs box-border w-[651px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[372px] left-[655px] rounded-8xs bg-gray-400 w-[151px] h-[55px]" />
        <div className="absolute top-[443px] left-[655px] rounded-8xs bg-gray-400 w-[151px] h-[55px]" />
        <div className="absolute top-[390px] right-[25px] font-semibold text-white text-center flex items-center justify-center w-[101px] h-5">
          본인 인증
        </div>
        <div className="absolute top-[461px] right-[25px] font-semibold text-white text-center flex items-center justify-center w-[101px] h-5">
          주소 찾기
        </div>
        <img
          className="absolute top-[326.6px] left-[772.6px] rounded-10xs w-[14.8px] h-[7.2px]"
          alt=""
          src="/dropdown-icon.svg"
        />
        <div className="absolute top-[17px] right-[183px] text-sm font-light text-red text-right flex items-center w-[177px] h-5">
          사용하실수 없는 아이디입니다
        </div>
        <div className="absolute top-[167px] right-[20px] text-sm font-light text-red text-right flex items-center w-[177px] h-5">
          비밀번호가 일치하지않습니다
        </div>
        <div className="absolute top-[92px] right-[20px] text-sm font-light text-red text-right flex items-center w-[177px] h-5">
          사용할수 없는 비밀번호입니다
        </div>
        <div className="absolute top-[390px] right-[584px] text-base font-medium text-darkgray-200 flex items-center w-[47px] h-5">
          통신사
        </div>
        <div className="absolute top-[320px] right-[197px] text-base font-medium text-darkgray-200 flex items-center w-[86px] h-5">
          이메일 선택
        </div>
        <img
          className="absolute top-[395.6px] left-[240.6px] rounded-12xs w-[13.8px] h-[7.9px]"
          alt=""
          src="/vector-181.svg"
        />
        <div className="absolute top-[0px] left-[155px] w-[488px] h-[55px]">
          <div className="absolute top-[0px] left-[0px] rounded-8xs box-border w-[488px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        </div>
        <div className="absolute top-[0px] left-[655px] rounded-8xs bg-gray-400 w-[151px] h-[55px]" />
        <div className="absolute top-[18px] right-[25px] font-semibold text-white text-center flex items-center justify-center w-[101px] h-5">
          중복 확인
        </div>
      </div>
      <div className="absolute top-[1409px] left-[760px] w-[400px] h-[70px] text-center text-xl text-white">
        <div className="absolute top-[0px] left-[0px] rounded-8xs bg-gray-400 w-[400px] h-[70px]" />
        <div className="absolute top-[0px] left-[88.5px] leading-[117.84%] font-medium flex items-center justify-center w-[215.8px] h-[70px]">
          회원가입 완료
        </div>
      </div>
      <header
