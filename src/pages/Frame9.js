...
const Frame9 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1526px] overflow-hidden text-center text-lgi text-black font-pretendard">
      <div className="absolute top-[1036px] left-[909px] bg-darkturquoise-100 w-12 h-12" />
      <div className="absolute top-[270px] left-[calc(50%_-_222px)] text-17xl font-extrabold text-gray-400 flex items-center justify-center w-[444px] h-[39px]">
        공지사항
      </div>
      <div className="absolute top-[437px] left-[295px] bg-gainsboro-500 box-border w-[1330px] h-20 border-b-[1px] border-solid border-gainsboro-300" />
      <div className="absolute top-[517px] left-[295px] bg-gainsboro-500 box-border w-[1330px] h-20 border-b-[1px] border-solid border-gainsboro-300" />
      <div className="absolute top-[597px] left-[295px] bg-gray-600 box-border w-[1330px] h-20 border-b-[1px] border-solid border-gainsboro-300" />
      <div className="absolute top-[677px] left-[295px] bg-gray-600 box-border w-[1330px] h-20 border-b-[1px] border-solid border-gainsboro-300" />
      <div className="absolute top-[757px] left-[295px] bg-gray-600 box-border w-[1330px] h-20 border-b-[1px] border-solid border-gainsboro-300" />
      <div className="absolute top-[837px] left-[295px] bg-gray-600 box-border w-[1330px] h-20 border-b-[1px] border-solid border-gainsboro-300" />
      <div className="absolute top-[917px] left-[295px] bg-gray-600 box-border w-[1330px] h-20 border-b-[1px] border-solid border-gainsboro-300" />
      <div className="absolute top-[465px] left-[395px] text-xl leading-[117.84%]">
        공지사항 제목이 들어가는 곳입니다.
      </div>
      <div className="absolute top-[545px] left-[395px] text-xl leading-[117.84%]">
        공지사항 제목이 들어가는 곳입니다.
      </div>
      <div className="absolute top-[625px] left-[325px] text-xl leading-[117.84%]">
        공지사항 제목이 들어가는 곳입니다.
      </div>
      <div className="absolute top-[705px] left-[325px] text-xl leading-[117.84%]">
        공지사항 제목이 들어가는 곳입니다.
      </div>
      <div className="absolute top-[785px] left-[325px] text-xl leading-[117.84%]">
        공지사항 제목이 들어가는 곳입니다.
      </div>
      <div className="absolute top-[865px] left-[325px] text-xl leading-[117.84%]">
        공지사항 제목이 들어가는 곳입니다.
      </div>
      <div className="absolute top-[945px] left-[325px] text-xl leading-[117.84%]">
        공지사항 제목이 들어가는 곳입니다.
      </div>
      <div className="absolute top-[466px] left-[1363px] leading-[117.84%]">
        2023.07.26
      </div>
      <div className="absolute top-[546px] left-[1363px] leading-[117.84%]">
        2023.07.26
      </div>
      <div className="absolute top-[626px] left-[1363px] leading-[117.84%]">
        2023.07.26
      </div>
      <div className="absolute top-[706px] left-[1363px] leading-[117.84%]">
        2023.07.26
      </div>
      <div className="absolute top-[786px] left-[1363px] leading-[117.84%]">
        2023.07.26
      </div>
      <div className="absolute top-[866px] left-[1363px] leading-[117.84%]">
        2023.07.26
      </div>
      <div className="absolute top-[946px] left-[1363px] leading-[117.84%]">
        2023.07.26
      </div>
      <div className="absolute top-[466px] left-[1527px] leading-[117.84%]">
        조회수 0
      </div>
      <div className="absolute top-[546px] left-[1527px] leading-[117.84%]">
        조회수 0
      </div>
      <div className="absolute top-[626px] left-[1527px] leading-[117.84%]">
        조회수 0
      </div>
      <div className="absolute top-[706px] left-[1527px] leading-[117.84%]">
        조회수 0
      </div>
      <div className="absolute top-[786px] left-[1527px] leading-[117.84%]">
        조회수 0
      </div>
      <div className="absolute top-[866px] left-[1527px] leading-[117.84%]">
        조회수 0
      </div>
      <div className="absolute top-[946px] left-[1527px] leading-[117.84%]">
        조회수 0
      </div>
      <div className="absolute top-[459px] left-[325px] rounded-[34.63px] bg-white box-border h-[35.5px] overflow-hidden flex flex-row items-center justify-center py-[5.328000068664551px] px-[11.544000625610352px] text-[15.98px] text-darkturquoise-100 border-[2px] border-solid border-darkturquoise-100">
        <div className="relative leading-[72.82px] font-medium flex items-center justify-center w-9 h-[33px] shrink-0">
          공지
        </div>
      </div>
      <div className="absolute top-[539px] left-[325px] rounded-[34.63px] bg-white box-border h-[35.5px] overflow-hidden flex flex-row items-center justify-center py-[5.328000068664551px] px-[11.544000625610352px] text-[15.98px] text-darkturquoise-100 border-[2px] border-solid border-darkturquoise-100">
        <div className="relative leading-[72.82px] font-medium flex items-center justify-center w-9 h-[33px] shrink-0">
          공지
        </div>
      </div>
      <div className="absolute bottom-[-4px] left-[0px] w-[1920px] h-[406px] text-left text-smi text-dimgray-300 font-noto-sans-kr">
      ...
      <div className="absolute top-[367px] left-[calc(50%_-_197px)] text-xl font-semibold text-darkturquoise-100 flex items-center justify-center w-[84px] h-px">
        공지사항
      </div>
      <div
        className="absolute top-[367px] left-[calc(50%_+_113px)] text-xl font-semibold text-lightgray-100 flex items-center justify-center w-[84px] h-px cursor-pointer"
        onClick={onFAQTextClick}
      >
        FAQ
      </div>
      <div className="absolute top-[391px] left-[650px] bg-darkturquoise-100 w-[310px] h-[5px]" />
      <div className="absolute top-[395px] left-[960px] bg-lightgray-100 w-[310px] h-0.5" />
      <img
        className="absolute right-[35px] bottom-[437px] w-[120px] h-[120px]"
        alt=""
        src="/-btn.svg"
      />
      <div className="absolute right-[50px] bottom-[562px] w-[90px] h-[90px] text-45xl text-limegreen-200">
      ...
      <div className="absolute top-[1049px] left-[929px] text-lg font-semibold text-white">
        1
      </div>
      <div className="absolute top-[1049px] left-[980px] text-lg font-semibold">
        2
      </div>
      <img
        className="absolute top-[1053.9px] left-[1017.3px] w-[9.8px] h-[11.3px]"
        alt=""
        src="/polygon-1.svg"
      />
      <header
