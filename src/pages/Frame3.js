...
const Frame3 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1212px] overflow-hidden text-center text-smi text-dimgray-300 font-pretendard">
      ...
      <b className="absolute top-[436px] left-[calc(50%_-_248px)] text-17xl flex text-gray-400 items-center w-[496px] h-[122px]">
        <span className="[line-break:anywhere] w-full">
          <p className="m-0">결제가 완료되었습니다.</p>
          <p className="m-0">구매해주셔서 감사합니다.</p>
        </span>
      </b>
      <img
        className="absolute right-[39px] bottom-[441px] w-[120px] h-[120px]"
        alt=""
        src="/-btn.svg"
      />
      <div className="absolute right-[54px] bottom-[566px] w-[90px] h-[90px] text-45xl text-limegreen-200">
