...
const Frame11 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1212px] overflow-hidden text-center text-smi text-dimgray-300 font-pretendard">
      <div className="absolute right-[0px] bottom-[0px] w-[1920px] h-[406px] text-left font-noto-sans-kr">
      ...
      <b className="absolute top-[419px] left-[calc(50%_-_248px)] text-17xl flex text-gray-400 items-center justify-center w-[496px] h-[39px]">
        회원가입을 진심으로 축하합니다.
      </b>
      <button
        className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[508px] left-[760px] w-[400px] h-[70px]"
        onClick={onGroupButtonClick}
      >
        <div className="absolute top-[0px] left-[0px] rounded-8xs bg-gray-400 w-[400px] h-[70px]" />
        <div className="absolute top-[0px] left-[88.5px] text-xl leading-[117.84%] font-medium font-pretendard text-white text-center flex items-center justify-center w-[215.8px] h-[70px]">
          로그인하기
        </div>
      </button>
      <img
