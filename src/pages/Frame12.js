...
const Frame12 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[2080px] overflow-hidden text-center text-3xl text-gray-400 font-pretendard">
      <div className="absolute top-[280px] left-[738px] text-17xl font-extrabold flex items-center justify-center w-[444px] h-[39px]">
        회원가입
      </div>
      <b className="absolute top-[368px] left-[495px] flex text-left items-center w-[226px] h-5">
        회원가입 약관동의
      </b>
      <b className="absolute top-[720px] left-[495px] flex text-left items-center w-[226px] h-5">
        개인정보 처리목적
      </b>
      <b className="absolute top-[1072px] left-[495px] flex text-left items-center w-[226px] h-5">
        광고수신동의
      </b>
      <img
        className="absolute top-[407.5px] left-[495px] w-[930px] h-px"
        alt=""
        src="/vector-61.svg"
      />
      <img
        className="absolute top-[759.5px] left-[495px] w-[930px] h-px"
        alt=""
        src="/vector-61.svg"
      />
      <img
        className="absolute top-[1111.5px] left-[495px] w-[930px] h-px"
        alt=""
        src="/vector-61.svg"
      />
      <div className="absolute top-[428px] left-[510px] rounded-8xs box-border w-[900px] h-[238px] border-[1px] border-solid border-lightgray-100" />
      <div className="absolute top-[780px] left-[510px] rounded-8xs box-border w-[900px] h-[238px] border-[1px] border-solid border-lightgray-100" />
      <div className="absolute top-[1132px] left-[510px] rounded-8xs box-border w-[900px] h-[238px] border-[1px] border-solid border-lightgray-100" />
      <div className="absolute top-[686px] left-[1204px] text-base leading-[117.84%] font-medium text-dimgray-100">
        회원가입 이용약관에 동의합니다.
      </div>
      <div className="absolute top-[1038px] left-[1204px] text-base leading-[117.84%] font-medium text-dimgray-100">
        개인정보 처리방침에 동의합니다.
      </div>
      <div className="absolute top-[454px] left-[1383px] w-[7px] h-[186px]">
        <div className="absolute top-[0px] left-[0px] rounded-2xs bg-gainsboro-400 w-[7px] h-[186px]" />
        <div className="absolute top-[21px] left-[0px] rounded-2xs bg-gray-200 w-[7px] h-8" />
      </div>
      <div className="absolute top-[806px] left-[1383px] w-[7px] h-[186px]">
        <div className="absolute top-[0px] left-[0px] rounded-2xs bg-gainsboro-400 w-[7px] h-[186px]" />
        <div className="absolute top-[21px] left-[0px] rounded-2xs bg-gray-200 w-[7px] h-8" />
      </div>
      <div className="absolute top-[1158px] left-[1383px] w-[7px] h-[186px]">
        <div className="absolute top-[0px] left-[0px] rounded-2xs bg-gainsboro-400 w-[7px] h-[186px]" />
        <div className="absolute top-[21px] left-[0px] rounded-2xs bg-gray-200 w-[7px] h-8" />
      </div>
      <input
        className="cursor-pointer absolute top-[687px] left-[1177px] rounded-[50%] box-border w-[17px] h-[17px] border-[1px] border-solid border-dimgray-100"
        required={true}
        type="radio"
      />
      <input
        className="cursor-pointer absolute top-[1039px] left-[1177px] rounded-[50%] box-border w-[17px] h-[17px] border-[1px] border-solid border-dimgray-100"
        required={true}
        type="radio"
      />
      <div className="absolute top-[1390px] left-[1259px] text-base leading-[117.84%] font-medium text-dimgray-100">
        광고 수신에 동의합니다.
      </div>
      <input
        className="cursor-pointer absolute top-[1391px] left-[1232px] rounded-[50%] box-border w-[17px] h-[17px] border-[1px] border-solid border-dimgray-100"
        required={true}
        type="radio"
      />
      <input
        className="cursor-pointer absolute top-[1486px] left-[829px] rounded-[50%] box-border w-5 h-5 border-[1px] border-solid border-dimgray-100"
        checked={true}
        type="radio"
      />
      <div className="absolute top-[1485px] left-[872px] text-lg leading-[117.84%] text-dimgray-100">
        회원가입 약관 전체 동의합니다.
      </div>
      <button
        className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[1540px] left-[965px] w-[260px] h-[70px]"
        onClick={onGroupButtonClick}
      >
        <div className="absolute top-[0px] left-[0px] rounded-8xs bg-gray-400 w-[260px] h-[70px]" />
        <div className="absolute top-[24.3px] left-[63.6px] text-3xl leading-[117.84%] font-pretendard text-white text-center flex items-center justify-center w-[132.2px] h-[21.4px]">
          회원가입
        </div>
      </button>
      <button
        className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[1540px] left-[695px] w-[260px] h-[70px]"
        onClick={onGroupButton1Click}
      >
        <div className="absolute top-[0px] left-[0px] rounded-8xs bg-darkturquoise-800 w-[260px] h-[70px]" />
        <div className="absolute top-[22px] left-[60px] text-3xl leading-[117.84%] font-medium font-pretendard text-darkturquoise-300 text-center flex items-center justify-center w-[139.2px]">
          취소
        </div>
      </button>
