...
const Frame4 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1377px] overflow-hidden text-left text-lg text-dimgray-300 font-pretendard">
      <div className="absolute top-[270px] left-[calc(50%_-_223px)] text-17xl font-extrabold text-gray-400 text-center flex items-center justify-center w-[444px] h-[39px]">
        주문 상세
      </div>
      ...
      <div className="absolute top-[389px] left-[310px] rounded-8xs bg-whitesmoke-500 box-border w-[1300px] h-[376px] border-[1px] border-solid border-gainsboro-100" />
      <div className="absolute top-[785px] left-[310px] rounded-8xs bg-whitesmoke-500 box-border w-[1300px] h-[105px] border-[1px] border-solid border-gainsboro-100" />
      <b className="absolute top-[359px] right-[1396px] text-xl flex items-center w-[214px] h-[17px] text-black">
        <span className="[line-break:anywhere] w-full">
          <span>주문번호</span>
          <span className="text-darkturquoise-200"> 0231234567</span>
        </span>
      </b>
      <div className="absolute top-[477px] right-[1396px] font-medium flex items-center w-[114px] h-[17px]">
        상품가격
      </div>
      <div className="absolute top-[467px] right-[410px] font-medium text-right flex items-center w-[49px] h-[17px]">
        0원
      </div>
      <div className="absolute top-[524px] right-[1396px] font-medium flex items-center w-[114px] h-[17px]">
        할인금액
      </div>
      <div className="absolute top-[524px] right-[410px] font-medium text-right flex items-center w-[49px] h-[17px]">
        0원
      </div>
      <div className="absolute top-[571px] right-[1396px] font-medium flex items-center w-[114px] h-[17px]">
        배송비
      </div>
      <div className="absolute top-[651px] right-[1461px] font-medium flex items-center w-[49px] h-[17px]">
        배송비
      </div>
      <div className="absolute top-[571px] right-[410px] font-medium text-right flex items-center w-[49px] h-[17px]">
        0원
      </div>
      <div className="absolute top-[651px] right-[411px] font-medium text-right flex items-center w-[49px] h-[17px]">
        0원
      </div>
      <b className="absolute top-[425px] right-[1482px] text-xl flex text-black items-center w-[85px] h-[17px]">
        결제정보
      </b>
      <b className="absolute top-[829px] right-[1482px] text-xl flex text-black items-center w-[85px] h-[17px]">
        배송정보
      </b>
      <b className="absolute top-[696px] right-[1400px] flex text-black items-center w-[110px] h-[17px]">
        총 결제금액
      </b>
      <b className="absolute top-[698px] right-[411px] flex text-black text-right items-center w-[70px] h-[17px]">
        0원
      </b>
      <img
        className="absolute top-[620.5px] left-[331px] w-[1259px] h-px"
        alt=""
        src="/vector-27.svg"
      />
      <div className="absolute top-[829px] right-[833px] font-medium flex items-center w-[618px] h-[17px]">{`(00000) 서울특별시 동대문구 00동 000-00 `}</div>
      <div className="absolute top-[829px] right-[393px] font-medium flex items-center w-[141px] h-[17px]">
        010-0000-0000
      </div>
      <img
