...
const Default1 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1978px] overflow-hidden text-left text-3xl text-gray-400 font-pretendard">
      ...
      <div
        className="absolute top-[1409px] left-[760px] w-[400px] h-[70px] cursor-pointer text-center text-xl text-white"
        onClick={onGroupContainerClick}
      >
        <button
          className="cursor-pointer [border:none] p-0 bg-gray-400 absolute top-[0px] left-[0px] rounded-8xs w-[400px] h-[70px]"
      ...
      <img
        className="absolute top-[405px] left-[495px] w-[930px] h-0.5"
        alt=""
        src="/vector-7.svg"
      />
      <img
        className="absolute top-[1113px] left-[495px] w-[930px] h-0.5"
        alt=""
        src="/vector-7.svg"
      />
      <div className="absolute top-[1144px] left-[558px] w-[805px] h-[205px] text-lg">
        <input
          className="bg-[transparent] absolute top-[0px] left-[155px] rounded-8xs box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100"
          type="text"
        />
        <div className="absolute top-[17px] right-[641px] font-medium flex items-center w-[164px] h-5">
          구매경로
        </div>
        <div className="absolute top-[92px] right-[641px] font-medium flex items-center w-[164px] h-5">
          구매하실 상품권
        </div>
        <div className="absolute top-[167px] right-[641px] font-medium flex items-center w-[164px] h-5">
          사용처
        </div>
        <div className="absolute top-[75px] left-[155px] w-[650px] h-[55px] text-base text-dimgray-100">
          <div className="absolute top-[0px] left-[0px] rounded-8xs box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
          <div className="absolute top-[17px] right-[373px] font-light flex items-center w-[257px] h-5">
            구매하시는 상품권을 선택해주세요
          </div>
          <img
            className="absolute top-[22.5px] left-[616.5px] rounded-10xs w-[15px] h-[7.8px]"
            alt=""
            src="/vector-91.svg"
          />
        </div>
        <select className="absolute top-[150px] left-[155px] w-[650px] h-[55px]" />
      </div>
      ...
      <div className="absolute top-[436px] right-[557px] w-[805px] h-[568px] text-lg">
        <div className="absolute top-[15px] right-[641px] font-medium flex items-center w-[164px] h-5">
          아이디
        </div>
        <div className="absolute top-[92px] right-[641px] font-medium flex items-center w-[164px] h-5">
          비밀번호
        </div>
        <div className="absolute top-[75px] left-[155px] w-[650px] h-[55px]">
          <input
            className="bg-[transparent] absolute top-[0px] left-[0px] rounded-8xs box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100"
            placeholder="영어 대/소문자 포함하여 4 ~ 12자까지 입력하세요."
            type="text"
          />
        </div>
        <div className="absolute top-[0px] left-[155px] w-[488px] h-[55px]">
          <input
            className="bg-[transparent] absolute top-[0px] left-[0px] rounded-8xs box-border w-[488px] h-[55px] border-[1px] border-solid border-gainsboro-100"
            type="text"
          />
        </div>
        <div className="absolute top-[321px] right-[317px] font-medium text-darkgray-200 flex items-center w-[15px] h-5">
          @
        </div>
        <div className="absolute top-[245px] right-[641px] font-medium flex items-center w-[164px] h-5">
          이름
        </div>
        <div className="absolute top-[167px] right-[641px] font-medium flex items-center w-[164px] h-5">
          비밀번호 확인
        </div>
        <div className="absolute top-[320px] right-[641px] font-medium flex items-center w-[164px] h-5">
          이메일
        </div>
        <div className="absolute top-[390px] right-[641px] font-medium flex items-center w-[164px] h-5">
          휴대폰 번호
        </div>
        <div className="absolute top-[460px] right-[743px] font-medium flex items-center w-[62px] h-5">
          주소
        </div>
        <input
          className="bg-[transparent] absolute top-[228px] left-[155px] rounded-8xs box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100"
          type="text"
        />
        <div className="absolute top-[150px] left-[155px] w-[650px] h-[55px]">
          <input
            className="bg-[transparent] absolute top-[0px] left-[0px] rounded-8xs box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100"
        ...
        <input
          className="bg-[transparent] absolute top-[303px] left-[155px] rounded-8xs box-border w-[303px] h-[55px] border-[1px] border-solid border-gainsboro-100"
          type="email"
        />
        <div className="absolute top-[443px] right-[160px] w-[490px] h-[55px] text-base text-dimgray-100">
          <div className="absolute top-[17px] right-[155.6px] font-light flex items-center w-[314.3px] h-5">
            주소를 입력하세요
          </div>
          <input
            className="bg-[transparent] absolute top-[0px] left-[0px] rounded-8xs box-border w-[490px] h-[55px] border-[1px] border-solid border-gainsboro-100"
            type="text"
          />
        </div>
        <div className="absolute top-[513px] right-[0px] w-[650px] h-[55px] text-base text-dimgray-100">
          <div className="absolute top-[17px] right-[317px] font-light flex items-center w-[313px] h-5">
            상세 주소를 입력하세요
          </div>
          <div className="absolute top-[0px] left-[0px] rounded-8xs box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        </div>
        <button className="cursor-pointer [border:none] p-0 bg-gray-400 absolute top-[372px] left-[655px] rounded-8xs w-[150px] h-[55px]" />
        <button className="cursor-pointer [border:none] p-0 bg-gray-400 absolute top-[0px] left-[655px] rounded-8xs w-[150px] h-[55px]" />
        <button className="cursor-pointer [border:none] p-0 bg-gray-400 absolute top-[443px] left-[655px] rounded-8xs w-[150px] h-[55px]" />
        <div className="absolute top-[390px] right-[24px] text-base font-semibold text-white text-center flex items-center justify-center w-[101px] h-5">
          본인 인증
        </div>
        <div className="absolute top-[18px] right-[24px] text-base font-semibold text-white text-center flex items-center justify-center w-[101px] h-5">
          중복 확인
        </div>
        <div className="absolute top-[461px] right-[24px] text-base font-semibold text-white text-center flex items-center justify-center w-[101px] h-5">
          주소 찾기
        </div>
        <input
          className="[border:none] bg-[transparent] absolute top-[303px] left-[502px] w-[303px] h-[55px]"
          placeholder="이메일 선택"
          type="email"
        />
        <input
          className="[border:none] bg-[transparent] absolute top-[372px] left-[155px] w-[490px] h-[55px]"
          type="number"
        />
      </div>
      <header
