...
const Frame7 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1580px] overflow-hidden text-left text-smi text-gray-400 font-pretendard">
      <div className="absolute bottom-[-5px] left-[0px] w-[1920px] h-[406px] text-dimgray-300 font-noto-sans-kr">
      ...
      <b className="absolute top-[364px] right-[1243px] text-3xl flex items-center w-[182px] h-5">
        회원정보
      </b>
      <img
        className="absolute top-[403px] left-[495px] w-[930px] h-0.5"
        alt=""
        src="/vector-7.svg"
      />
      <div className="absolute top-[434px] left-[558px] w-[805px] h-[568px] text-base text-dimgray-100">
        <div className="absolute top-[0px] left-[155px] w-[650px] h-[55px]">
          <div className="absolute top-[0px] left-[0px] rounded-8xs bg-gainsboro-600 box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        </div>
        <div className="absolute top-[228px] left-[155px] rounded-8xs bg-gainsboro-600 box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[75px] left-[155px] rounded-8xs box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[15px] right-[641px] text-lg font-medium text-gray-400 flex items-center w-[164px] h-5">
          아이디
        </div>
        <div className="absolute top-[92px] right-[641px] text-lg font-medium text-gray-400 flex items-center w-[164px] h-5">
          비밀번호
        </div>
        <div className="absolute top-[92px] right-[552px] font-light flex items-center w-[78px] h-5">
          **********
        </div>
        <div className="absolute top-[167px] right-[552px] font-light flex items-center w-[78px] h-5">
          **********
        </div>
        <div className="absolute top-[321px] right-[552px] font-light flex items-center w-[78px] h-5">
          aaa0000
        </div>
        <div className="absolute top-[390px] right-[409px] font-light flex items-center w-[120px] h-5">
          01012345678
        </div>
        <div className="absolute top-[321px] right-[204px] font-light flex items-center w-[78px] h-5">
          naver.com
        </div>
        <div className="absolute top-[530px] right-[317px] font-light flex items-center w-[313px] h-5">
          000동 000호
        </div>
        <div className="absolute top-[17px] right-[477px] font-light flex items-center w-[153px] h-5">
          aaa0000
        </div>
        <div className="absolute top-[245px] right-[477px] font-light flex items-center w-[153px] h-5">
          홍길동
        </div>
        <div className="absolute top-[461px] right-[371px] font-light flex items-center w-[259px] h-5">
          서울특별시 동대문구 00로 00길
        </div>
        <div className="absolute top-[17px] right-[21px] font-medium text-darkturquoise-100 text-center flex items-center justify-center w-[62px] h-5">
          수정불가
        </div>
        <div className="absolute top-[245px] right-[21px] font-medium text-darkturquoise-100 text-center flex items-center justify-center w-[62px] h-5">
          수정불가
        </div>
        <div className="absolute top-[321px] right-[317px] text-lg font-medium text-darkgray-200 flex items-center w-[15px] h-5">
          @
        </div>
        <div className="absolute top-[245px] right-[641px] text-lg font-medium text-gray-400 flex items-center w-[164px] h-5">
          이름
        </div>
        <div className="absolute top-[167px] right-[641px] text-lg font-medium text-gray-400 flex items-center w-[164px] h-5">
          비밀번호 확인
        </div>
        <div className="absolute top-[320px] right-[641px] text-lg font-medium text-gray-400 flex items-center w-[164px] h-5">
          이메일
        </div>
        <div className="absolute top-[390px] right-[641px] text-lg font-medium text-gray-400 flex items-center w-[164px] h-5">
          휴대폰 번호
        </div>
        <div className="absolute top-[460px] right-[743px] text-lg font-medium text-gray-400 flex items-center w-[62px] h-5">
          주소
        </div>
        <div className="absolute top-[150px] left-[155px] rounded-8xs box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        ...
        <div className="absolute top-[303px] left-[503px] rounded-8xs box-border w-[302px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        ...
        <div className="absolute top-[513px] left-[155px] rounded-8xs box-border w-[650px] h-[55px] border-[1px] border-solid border-gainsboro-100" />
        <div className="absolute top-[372px] left-[655px] rounded-8xs bg-gray-400 w-[150px] h-[55px]" />
        <div className="absolute top-[443px] left-[655px] rounded-8xs bg-gray-400 w-[150px] h-[55px]" />
        <div className="absolute top-[390px] right-[24px] font-semibold text-white text-center flex items-center justify-center w-[101px] h-5">
          본인 인증
        </div>
        <div className="absolute top-[461px] right-[24px] font-semibold text-white text-center flex items-center justify-center w-[101px] h-5">
          주소 찾기
        </div>
        <img
          className="absolute top-[326.6px] left-[767.6px] rounded-10xs w-[14.8px] h-[7.2px]"
          alt=""
          src="/dropdown-icon.svg"
        />
        <div className="absolute top-[390px] right-[583px] font-medium text-darkgray-200 flex items-center w-[47px] h-5">
          통신사
        </div>
        <img
      ...
      <div
        className="absolute top-[1052px] left-[760px] w-[400px] h-[70px] cursor-pointer text-center text-xl text-white"
      ...
      <img
        className="absolute right-[37px] bottom-[439px] w-[120px] h-[120px]"
        alt=""
        src="/-btn.svg"
      />
      <div className="absolute right-[52px] bottom-[564px] w-[90px] h-[90px] text-center text-45xl text-limegreen-200">
